...
class MrpEco(models.Model):
    ...
    interpod_update_routing = fields.Selection([('required','Required'),('not required','Not Required'),('complete','Complete')], string = "Update Routing", required = False, translate = False)
    interpod_update_qc_docs = fields.Selection([('required','Required'),('not required','Not Required'),('complete','Complete')], string="Update QC Docs", required = False, translate = False, help = "Update QC documentation, including QC inspections, QC Checkpoints, and ITP's")
